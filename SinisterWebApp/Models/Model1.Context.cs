...
namespace SinisterWebApp.Models
{
    ...
    public partial class sinisterEntities : DbContext
    {
        public sinisterEntities()
            : base("name=sinisterEntities")
        {
        }
        ...
        public virtual DbSet<DestructionLevels> DestructionLevels { get; set; }
